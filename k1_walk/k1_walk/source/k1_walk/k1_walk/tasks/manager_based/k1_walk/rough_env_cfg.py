...
class MySceneCfg(InteractiveSceneCfg):
    ...
    # base ではなく trunk_link に合わせる
    height_scanner = RayCasterCfg(
        prim_path="{ENV_REGEX_NS}/Robot/trunk_link",
    ...
    contact_foot_right = ContactSensorCfg(
    ...
    contact_foot_left = ContactSensorCfg(
...
class K1Rewards:
    ...
    knee_limit_lower = RewTerm(
        func=mdp.knee_limit_lower,
        weight=-1.0,
        params={"knee_limit_angle": 0.0},
    )
...
class K1RoughEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.terminations.root_height_low.params["asset_cfg"].body_names = "trunk_link"
